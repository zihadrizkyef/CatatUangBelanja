...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final settingGroups = [
      _SettingGroup('Akun', [
        _SettingItem(AppIcons.profile, 'Profil', () => _showComingSoon(context)),
        _SettingItem(AppIcons.security, 'Keamanan', () => _showComingSoon(context)),
      ]),
      _SettingGroup('Preferensi', [
        _SettingItem(AppIcons.notification, 'Notifikasi', () => _showComingSoon(context)),
        _SettingItem(AppIcons.categoryBudgetSetting, 'Kategori & Anggaran', () => _openBudgetScreen(context)),
        _SettingItem(AppIcons.language, 'Bahasa', () => _showComingSoon(context)),
      ]),
      _SettingGroup('Lainnya', [
        _SettingItem(AppIcons.help, 'Bantuan', () => _showComingSoon(context)),
        _SettingItem(AppIcons.about, 'Tentang Aplikasi', () => _showAbout(context)),
      ]),
    ];
              ...
              child: Transform.translate(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: Colors.black.withValues(alpha: isDark ? 0.35 : 0.10), blurRadius: 30, offset: const Offset(0, 10)),
                    ],
                  ),
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const TwemojiIcon(AppIcons.profileAvatar, size: 24),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('sari@keluarga.id', style: AppTheme.body(fontSize: 12, fontWeight: FontWeight.bold, color: palette.textSecondary)),
                          ],
                        ),
                      ),
                      Material(
                        ...
                        child: InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Text('Edit', style: AppTheme.body(fontSize: 12, fontWeight: FontWeight.bold, color: palette.warningText)),
                          ),
                        ),
                      ),
                    ],
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 12),
                          Expanded(child: Text('Mode Gelap', style: AppTheme.body(fontSize: 13, fontWeight: FontWeight.bold, color: palette.textPrimary))),
                          Switch(
                            value: isDark,
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      TwemojiIcon(group.items[i].icon, size: 18),
                                      const SizedBox(width: 12),
                                      Expanded(child: Text(group.items[i].label, style: AppTheme.body(fontSize: 13, fontWeight: FontWeight.bold, color: palette.textPrimary))),
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Text('Keluar', textAlign: TextAlign.center, style: AppTheme.body(fontSize: 13, fontWeight: FontWeight.bold, color: palette.warningText)),
                        ),
                      ),
                    ),
                  ),
