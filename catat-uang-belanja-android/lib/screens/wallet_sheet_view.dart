...
/// Pure layout for [WalletSheet]'s add/edit bottom sheet: name field,
/// icon-picker grid, a save action, and — in edit mode — a delete action.
/// All data/callbacks come from the [WalletSheet] container — this widget
/// never touches [FinanceRepository] or [Navigator] itself.
class WalletSheetView extends StatelessWidget {
  const WalletSheetView({
    super.key,
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              crossAxisSpacing: 8,
              children: [
                for (final iconValue in AppIcons.walletIconChoices)
...
@Preview(name: 'WalletSheetView · tambah')
Widget previewWalletSheetViewAdd() {
  return WalletSheetView(
    isEdit: false,
    nameController: TextEditingController(),
    selectedIconValue: 'wallet_cash',
    onSelectIcon: (_) {},
    onSave: () {},
    onClose: () {},
  );
...
@Preview(name: 'WalletSheetView · edit')
Widget previewWalletSheetViewEdit() {
  return WalletSheetView(
    isEdit: true,
    nameController: TextEditingController(text: 'Rekening Bank'),
    selectedIconValue: 'wallet_bank',
    onSelectIcon: (_) {},
    onSave: () {},
    onClose: () {},
    onDelete: () {},
