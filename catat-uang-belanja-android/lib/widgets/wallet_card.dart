...
/// A single wallet row in Dompet's "Dompet Saya" list.
class WalletCard extends StatelessWidget {
  const WalletCard({super.key, required this.wallet, required this.indexLabel, required this.balance, required this.palette});
